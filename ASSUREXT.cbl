      ...
      *    Variables pour afficher les montants avec format.
       01  WS-FORMATTED-TOTAL-MONTANT         PIC Z,ZZZ,ZZZ,ZZ9.99.
       01  WS-FORMATTED-TOTAL-MONTANT-ACTIF   PIC Z,ZZZ,ZZZ,ZZ9.99.
       01  WS-FORMATTED-TOTAL-MONTANT-RESILIE PIC Z,ZZZ,ZZZ,ZZ9.99.
       01  WS-FORMATTED-TOTAL-MONTANT-SUSPENDU PIC Z,ZZZ,ZZZ,ZZ9.99.
